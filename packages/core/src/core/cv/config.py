...
from base.dataset import IndexableDataset, Prediction
...
# class _CvMlModelConfig[
#     T: IndexableDataset, U: RawModel, V: BaseTrainConfig, W: BasePredictConfig
# ](_BaseMlModelConfig[IndexedDatasets[T], CvRawModels[U], V, W]):
#     @property
#     def _model_config(
#         self,
#     ) -> _BaseMlModelConfig[IndexedDatasets[T], CvRawModels[U], V, W]:
#         return _BaseMlModelConfig(
#             train_config=self.train_config, pred_config=self.pred_config
#         )
